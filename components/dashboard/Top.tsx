...
export default function Navbar() {
  ...
  return (
    <header>
      <div className="bg-gradient-to-r  from-green-100  to-blue-100 pt-2 pb-3">
          ...
          <nav className="relative flex items-center justify-between h-16 lg:h-16">
            ...
            <div className="hidden  lg:flex font-body4 lg:items-center gap-7">
              <Link
                href="#"
                title=""
                className="text-md font-medium bg-gradient-to-r  from-green-400  to-blue-400 rounded-full p-2 text-green-800"
              >
                <svg
            ...
            <div className="hidden lg:flex lg:items-center lg:space-x-10">
              <Button
                radius="full"
                className="bg-[#197e9e]  text-white font-body4"
              >
                Activity
              </Button>
            </div>
